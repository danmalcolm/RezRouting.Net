            ...
            get
            {
                ...
                mapper.Configure(configuration =>
                {
                    ...
                    var custom1 = new RouteType("Custom1", new[] { ResourceType.Collection },
                        CollectionLevel.Item, "Custom1", "custom", StandardHttpMethod.Get, 9, 
                        customize: x => x.QueryStringValues(new { variation = "1" })
                        );
                    var custom2 = new RouteType("Custom2", new[] {ResourceType.Collection},
                        CollectionLevel.Item, "Custom2", "custom", StandardHttpMethod.Get, 9,
