...
{
    public class NestedResourceRouteMappingTests
    {
        [Theory, PropertyData("Collections2LevelsDeepExpectations")]
        public void Collections2LevelsDeep(MappingExpectation expectation)
        {
            expectation.Verify();
        }

        public static IEnumerable<object[]> Collections2LevelsDeepExpectations
        {
            get
            {
        ...
        [Theory, PropertyData("Collections3LevelsDeepExpectations")]
        public void Collections3LevelsDeep(MappingExpectation expectation)
        {
            expectation.Verify();
        }

        public static IEnumerable<object[]> Collections3LevelsDeepExpectations
        {
            get
            {
        ...
        [Theory, PropertyData("SingularWithinCollectionExpectations")]
        public void SingularWithinCollection(MappingExpectation expectation)
        {
            expectation.Verify();
        }

        public static IEnumerable<object[]> SingularWithinCollectionExpectations
        {
            get
            {
                var mapper = new RouteMapper();
