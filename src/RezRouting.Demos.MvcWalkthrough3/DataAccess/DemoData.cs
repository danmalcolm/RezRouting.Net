    ...
    public class DemoData
    {
        static DemoData()
        {
            ...
            Reviews = (from product in Products
                ...
                select new Review
                {
                    ...
                    Comments = (good ? "It's good " : "I don't like it") + TestDataHelper.LoremShort,
                    Score = good ? 10 : 2,
                    CreatedOn = product.CreatedOn + TimeSpan.FromMinutes(4 * reviewNumber),
            ...
            where TEntity : Entity
        {
            ...
            if (typeof(TEntity) == typeof(Review))
                entity = Reviews.SingleOrDefault(x => x.Id == id);
            ...
            where TEntity : Entity
        {
            ...
            if (typeof(TEntity) == typeof(Review))
                return (IQueryable<TEntity>)Reviews.AsQueryable();
